        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium text-slate-900">{consultation.name}</p>
              </div>
              <div>
                <p className="text-xs text-slate-500 uppercase tracking-wide">Email</p>
                <p className="text-sm font-medium text-slate-900">{consultation.email}</p>
              </div>
              <div className="col-span-2">
                <p className="text-xs text-slate-500 uppercase tracking-wide">Phone</p>
                <p className="text-sm font-medium text-slate-900">{consultation.phone}</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <p className="text-xs text-slate-500 uppercase tracking-wide">Service Requested</p>
          ...
          <div className="pt-4 border-t space-y-2">
            <div className="flex justify-between text-xs">
              ...
              <span className="text-slate-700 font-medium">{formatDate(consultation.createdAt)}</span>
            </div>
            <div className="flex justify-between text-xs">
              <span className="text-slate-500">Last Updated:</span>
              <span className="text-slate-700 font-medium">{formatDate(consultation.updatedAt)}</span>
            </div>
          </div>
        </div>
      </DialogContent>
