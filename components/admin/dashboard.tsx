      ...
      <header className="border-b border-slate-200 sticky top-0 z-50 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between gap-2">
          <div className="min-w-0 flex-1">
            <h1 className="text-lg sm:text-2xl font-bold truncate">Dandeal Manager</h1>
            <p className="text-xs sm:text-sm hidden sm:block">Manage quotes and consultation requests</p>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          <div className="w-full overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
            <TabsList className="inline-flex lg:grid w-full lg:max-w-7xl lg:grid-cols-7 h-auto p-1 min-w-max lg:min-w-0">
              ...
              <TabsTrigger value="dropdowns" className="whitespace-nowrap">Dropdowns</TabsTrigger>
              <TabsTrigger value="partners" className="whitespace-nowrap">Partners</TabsTrigger>
              <TabsTrigger value="users" className="gap-1 sm:gap-2 whitespace-nowrap">
                <Users className="w-4 h-4" />
                Users
              </TabsTrigger>
              <TabsTrigger value="settings" className="gap-1 sm:gap-2 whitespace-nowrap">
